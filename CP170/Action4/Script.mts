	...
	Select Case ucase(Equipo)
		Case "HUAWEI P10 NEGRO"
	   	...
	   	Case "HUAWEI Y8S NEGRO JKM-LX3"
	   		Call Carga()
	   		wait 8
	   		While JavaWindow("Ejecutivo de interacción").JavaDialog("Alta Express (Para WALTHER").JavaCheckBox("Seleccionar_3").Exist = False
	   			wait 1
	   		Wend
	   		wait 1
	   		JavaWindow("Ejecutivo de interacción").JavaDialog("Alta Express (Para WALTHER").JavaCheckBox("Seleccionar_3").Set "ON"
...
'		wait 1
		Dim fg
		fg = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").GetROProperty("text")
		DataTable("s_Resultado", dtlocalSheet) = fg

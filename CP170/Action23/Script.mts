...
'While Window("Ejecutivo de interacción").InsightObject("InsightObject_21").Exist = False
'	wait 1
'Wend
'wait 1
'Window("Ejecutivo de interacción").InsightObject("InsightObject_21").Click
While Window("Ejecutivo de interacción").InsightObject("InsightObject_22").Exist = False
	wait 1
Wend
wait 1
...
'	shell.SendKeys "{PGDN 1}"
	While Window("Ejecutivo de interacción").InsightObject("InsightObject_20").Exist = false
		wait 1
		Set shell = CreateObject("Wscript.Shell") 
...
'	Window("Ejecutivo de interacción").InsightObject("InsightObject_6").Click
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Formulario").Close
	wait 1
End If

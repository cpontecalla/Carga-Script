...
Sub CambioTitularidad()
	...
	While ((JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Actualizar Atributos de").JavaEdit("Texto del motivo:").Exist) Or (JavaWindow("Ejecutivo de interacción").JavaDialog("Mensaje").Exist)) = False
		wait 1
	Wend
	...
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Mensaje").Exist(2) Then
		...
		Reporter.ReportEvent micFail, DataTable("s_Resultado",dtLocalSheet), DataTable("s_Detalle",dtLocalSheet)
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"MensajeValidación.png", True
		imagenToWord "Mensaje de Validación", RutaEvidencias() &"MensajeValidación.png"

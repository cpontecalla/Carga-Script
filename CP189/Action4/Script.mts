...
Sub OrdenCerrada()
	...
	Set shell = CreateObject("Wscript.Shell") 
	shell.SendKeys "{ENTER}"
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1101285A").JavaEdit("ID de acción de orden:").Exist = False
		wait 1
	Wend
	wait 1
	Dim gh
	gh = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1101285A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	While gh = ""
		wait 1
		gh = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1101285A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	Wend
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1101285A").JavaTab("Nombre del cliente:").Select "Actividad"
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1101285A").JavaTable("SearchJTable").Exist = False
		wait 1
	Wend
	wait 4
	...
	shell.SendKeys "{PGDN 2}"
	wait 1
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"AccionOrden1.png", True
	imagenToWord "Acción de Orden", RutaEvidencias() &"AccionOrden1.png"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1101285A").Close
	wait 2
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Buscar: Orden").JavaButton("Cerrar").Click

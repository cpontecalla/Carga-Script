...
Sub OrdenCerrada()
	...
	Set shell = CreateObject("Wscript.Shell") 
	shell.SendKeys "{ENTER}"
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1088876A").JavaEdit("ID de acción de orden:").Exist = False
		wait 1
	Wend
	wait 1
	Dim go
	go =  JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1088876A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	While go = ""
		wait 1
		go =  JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1088876A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	Wend
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1088876A").JavaTab("Nombre del cliente:").Select "Actividad"
	wait 1
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1088876A").JavaTable("SearchJTable").Exist = False
		wait 1
	Wend
	wait 5
	...
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1088876A").Close
	wait 3
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Buscar: Orden").JavaButton("Cerrar").Click

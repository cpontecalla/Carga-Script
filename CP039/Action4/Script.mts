...
Sub ActualizarAtributos()
	...
	wait 3
	While ((JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Actualizar Atributos de").JavaList("Equipo").Exist)or(JavaWindow("Ejecutivo de interacción").JavaDialog("Mensajes de validación").Exist))=False
		wait 1
	Wend
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Mensajes de validación").Exist(2) Then
		...
		wait 2
		JavaWindow("Ejecutivo de interacción").JavaDialog("Actualizar Atributos de").JavaList("Motivo:").Select "Pedido de Cliente"
		wait 2

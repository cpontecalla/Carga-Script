...
Sub OrdenCerrada()
	...
	Set shell = CreateObject("Wscript.Shell") 
	shell.SendKeys "{ENTER}"
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1099221A").JavaEdit("ID de acción de orden:").Exist = False
		wait 1
	Wend
	Dim fj
	fj = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1099221A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	While fj = ""
		wait 1
		fj = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1099221A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	Wend
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1099221A").JavaTab("Nombre del cliente:").Select "Actividad"
	wait 1
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1099221A").JavaTable("SearchJTable").Exist = false
		wait 1
	Wend
	wait 5
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"AccionOrden.png", True
	imagenToWord "Acción de Orden", RutaEvidencias() &"AccionOrden.png"
	wait 1
	Set shell = CreateObject("Wscript.Shell") 
	shell.SendKeys "{PGDN 2}"
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"AccionOrden2.png", True
	imagenToWord "Acción de Orden", RutaEvidencias() &"AccionOrden2.png"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1099221A").Close
	wait 2
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Buscar: Orden").JavaButton("Cerrar").Click

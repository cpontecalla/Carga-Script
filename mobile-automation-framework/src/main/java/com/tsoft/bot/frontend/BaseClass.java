...
public class BaseClass {
    ...
    public static void stepPass(MobileDriver driver, String descripcion) throws Throwable {
        try {
...
//    }
    ...
    public static void stepFail(WebDriver driver, String descripcion) throws Exception {
        try {
...
//    }
    ...
    public Boolean isPresent(WebDriver driver, String key, String locator) throws Throwable {
        try{
            Boolean webElement;
            switch (key.toLowerCase()) {
                case "id":
                    webElement = driver.findElements(By.id(locator)).size() > 0;
                    break;
                case "name":
                    webElement = driver.findElements(By.name(locator)).size() > 0;
                    break;
                case "css":
                    webElement = driver.findElements(By.cssSelector(locator)).size() > 0;
                    break;
                case "linktext":
                    webElement = driver.findElements(By.linkText(locator)).size() > 0;
                    break;
                case "xpath":
                    webElement = driver.findElements(By.xpath(locator)).size() > 0;
                    break;
                default:
                    webElement = null;
            }

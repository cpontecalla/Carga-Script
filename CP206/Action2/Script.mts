...
Sub OrdenCerrada()
	...
	Set shell = CreateObject("Wscript.Shell") 
	shell.SendKeys "{ENTER}"
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1093500A").JavaEdit("ID de acción de orden:").Exist = False
		wait 1
	Wend
	Dim g
	g = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1093500A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	While g = ""
		wait 1
		g = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1093500A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	Wend
	...
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1093500A").JavaTab("Nombre del cliente:").Select "Actividad"
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1093500A").JavaTable("SearchJTable").Exist = False
		wait 1
	Wend
	wait 3
	Set shell = CreateObject("Wscript.Shell") 
	...
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1093500A").Close
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Buscar: Orden").JavaButton("Cerrar").Click

...
Sub EnviarPago()
	...
	imagenToWord "Envio de Pago",RutaEvidencias() & "EnviarPago.png"
			...
			Do
				...
				Select Case TipoAlta
					...
					Case "Alta equipo + SIM"
						wait 1
						Dim option1, option2
						option1 =  JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").GetCellData("#1", "#1")
						option2 =  JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").GetCellData("#2", "#1")
						If option1 = "Dispositivo" Then
							...
							wait 2
						ElseIf option1 = "Tarjeta SIM" Then
							JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").DoubleClickCell "#1","#4"
							Set shell = CreateObject("Wscript.Shell") 
							shell.SendKeys "{ENTER}"
							wait 2
						...
						End If
					  	...
					  	If option2 = "Dispositivo" Then
							...
							wait 2
						ElseIf option2 = "Tarjeta SIM" Then
							JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").DoubleClickCell "#2","#4"
							Set shell = CreateObject("Wscript.Shell") 
							shell.SendKeys "{ENTER}"
							wait 2
...
Sub OrdenCerrada()
	...
	Set shell = CreateObject("Wscript.Shell") 
	shell.SendKeys "{ENTER}"
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1100090A").JavaEdit("ID de acción de orden:").Exist = False
		wait 1
	Wend
	wait 1
	Dim jo
	jo = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1100090A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	While jo = ""
		wait 1
		jo = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1100090A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	Wend
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1100090A").JavaTab("Nombre del cliente:").Select "Actividad"
	wait 1
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1100090A").JavaTable("SearchJTable").Exist = False
		wait 1
	Wend
	wait 4
	...
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 1100090A").Close
	wait 3
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Buscar: Orden").JavaButton("Cerrar").Click

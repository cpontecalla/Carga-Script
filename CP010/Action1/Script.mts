...
'	wait 10
	...
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Select "#0;Móvil;Promociones y Descuentos Especiales;Promo Dscto 50% Renta x 6 meses" @@ hightlight id_;_3533563_;_script infofile_;_ZIP::ssf15.xml_;_
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Agregar").Click @@ hightlight id_;_806804_;_script infofile_;_ZIP::ssf17.xml_;_
	...
	wait 2
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Validar").Click @@ hightlight id_;_4619794_;_script infofile_;_ZIP::ssf18.xml_;_
	wait 8
...
JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Expand "#0;Móvil;Promociones y Descuentos Especiales" @@ hightlight id_;_3533563_;_script infofile_;_ZIP::ssf14.xml_;_
JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Select "#0;Móvil;Promociones y Descuentos Especiales;Promo Dscto 50% Renta x 6 meses" @@ hightlight id_;_3533563_;_script infofile_;_ZIP::ssf15.xml_;_
JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Agregar").Click @@ hightlight id_;_806804_;_script infofile_;_ZIP::ssf17.xml_;_
wait 2
JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Validar").Click @@ hightlight id_;_4619794_;_script infofile_;_ZIP::ssf18.xml_;_

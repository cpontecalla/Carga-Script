...
Sub InstruccionesEnvio()
	...
	Wend
	Dim fg
	fg = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar dirección de").JavaEdit("Dirección").GetROProperty("text")
	While fg = ""
		wait 1
		fg = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar dirección de").JavaEdit("Dirección").GetROProperty("text")
	Wend
	...
	Wend
	Dim f
	f = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar dirección de_2").JavaButton("1 Registros").GetROProperty("text")
	While f = "-- Registros"
		wait 1
		f = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar dirección de_2").JavaButton("1 Registros").GetROProperty("text")
	Wend
	If f = "0 Registros" Then
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "Direccion.png", True
		imagenToWord "Dirección de envio no encontrado",RutaEvidencias() & "Direccion.png"
		wait 1
		ExitActionIteration
	End If
	...
	imagenToWord "Seleccionamos dirección de envio",RutaEvidencias() & "DireccionEnvio.png"
...
RunAction "CONTRATO", oneIteration
		wait 1

...
DataTable("s_Resultado","RecoxRobo") ="Fallido"
DataTable("s_Detalle","RecoxRobo") ="Error al consultar servicio web"
Reporter.ReportEvent micFail, DataTable("s_Resultado","RecoxRobo"), DataTable("s_Detalle","RecoxRobo")
ExitTestIteration
End If

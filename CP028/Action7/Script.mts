...
Sub BuscarSuscripcion()
	...
	End If
		...
		Wend
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Panel de Interacción").JavaRadioButton("Sólo contacto").Set "ON"
	wait 2
...
'				wait 1
			If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaButton("Validar y Ver Contrato").Exist Then
				varprueba=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaButton("Validar y Ver Contrato").GetROProperty("enabled")
				If varprueba="1" Then
...
'			Wend
	...
	varprueba=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaCheckBox("El cliente firmó.").GetROProperty("enabled")
	If varprueba="1" Then
...
'			Wait 2
		...
		If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Panel de Interacción").JavaButton("Finalizar").Exist(1) Then
			...
			End If
		End If
 @@ hightlight id_;_16366095_;_script infofile_;_ZIP::ssf1.xml_;_
	End If
End  Sub
Sub BuscarOrden()

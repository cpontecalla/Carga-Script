...
'				
			...
			Wend
			Dim g
			g = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaEdit("Nombre y Dirección de").GetROProperty("text")
			While g = ""
				wait 1
				g = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaEdit("Nombre y Dirección de").GetROProperty("text")
			Wend
			...
			wait 1
			JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"NegociarDistribución.png", True
			imagenToWord "Negociar Distribución de Cargos", RutaEvidencias() &"NegociarDistribución.png"
			wait 1
			JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaButton("Siguiente >").Click
...
'			ExitActionIteration
	...
	Wend
	Dim c
	c = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaEdit("BAR ID").GetROProperty("text")
	While c = ""
		wait 1
		c = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaEdit("BAR ID").GetROProperty("text")
	Wend

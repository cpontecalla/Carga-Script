...
'			Loop While Not varValidaRespuestaCumplimiento = "Manejar Respuesta de Cumplimiento"
			Wait 5
		JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Buscar: Grupo de órdenes").JavaTab("Equipo usuario:").SelectRow "#0"
		Wait 2
	...
	Reporter.ReportEvent micPass,"Se valida el estado de la orden", DataTable("s_ValEstadoOrden", dtLocalSheet)
		...
		Do
			...
			wait 3
				...
				End If
		Loop While Not ((DataTable("s_ValEstadoOrden", dtLocalSheet) = "Programado") Or (DataTable("s_ValEstadoOrden", dtLocalSheet) = "Cerrado"))

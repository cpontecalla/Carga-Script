...
While ((Window("Ejecutivo de interacción").InsightObject("InsightObject_7").Exist) Or (Window("Ejecutivo de interacción").InsightObject("InsightObject_8").Exist))= false
	wait 1
Wend
wait 1
If Window("Ejecutivo de interacción").InsightObject("InsightObject_19").Exist = true Then
	Call Validacion()
End If
If Window("Ejecutivo de interacción").InsightObject("InsightObject_7").Exist Then

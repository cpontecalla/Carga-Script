...
Sub OrdenCerrada()
	...
	Set shell = CreateObject("Wscript.Shell") 
	shell.SendKeys "{ENTER}"
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 999244A").JavaEdit("ID de acción de orden:").Exist = False
		wait 1
	Wend
	Dim gh
	gh = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 999244A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	While gh = ""
		wait 1
		gh = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 999244A").JavaEdit("ID de acción de orden:").GetROProperty("text")
	Wend
	...
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 999244A").JavaTab("Nombre del cliente:").Select "Actividad"

	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 999244A").JavaTable("SearchJTable").Exist = false
		wait 1
	Wend
	wait 5
	...
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver acción de orden: 999244A").Close
	wait 3
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Buscar: Orden").JavaButton("Cerrar").Click

...
'	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaEdit("TextFieldNative$1").Set "6%%%%%%%%"
	...
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Select "#0;Móvil;Promociones y Descuentos Especiales;Bono Movistar 1GB 60d (VR S/ 25.64)" @@ hightlight id_;_3533563_;_script infofile_;_ZIP::ssf19.xml_;_
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Agregar").Click
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"BonoMovistar.png", True
	imagenToWord "Bono Movistar S/25.64)", RutaEvidencias() &"BonoMovistar.png"
	wait 2
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Validar").Click
	wait 8
...
JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Expand "#0;Móvil;Datos;Paquete de Datos" @@ hightlight id_;_3533563_;_script infofile_;_ZIP::ssf14.xml_;_
JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Select "#0;Móvil;Datos;Paquete de Datos;Full Internet 2GB" @@ hightlight id_;_3533563_;_script infofile_;_ZIP::ssf15.xml_;_
wait 2
JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Agregar").Click @@ hightlight id_;_806804_;_script infofile_;_ZIP::ssf16.xml_;_
wait 2
JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Validar").Click @@ hightlight id_;_4619794_;_script infofile_;_ZIP::ssf17.xml_;_
wait 8


JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Expand "#0;Móvil;Promociones y Descuentos Especiales" @@ hightlight id_;_3533563_;_script infofile_;_ZIP::ssf18.xml_;_
JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Select "#0;Móvil;Promociones y Descuentos Especiales;Bono Movistar 1GB 60d (VR S/ 25.64)" @@ hightlight id_;_3533563_;_script infofile_;_ZIP::ssf19.xml_;_
JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Agregar").Click @@ hightlight id_;_806804_;_script infofile_;_ZIP::ssf20.xml_;_

...
'	Wend
	...
	For Iterator = 0 To CantFilas Step 1
		...
		If ((NombreOf = "Plan Acceso Total S/20 C")) Then
...
'	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").SetCellData "#0","#1", "Pruebas"
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").ClickCell "#1","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").SetCellData "#1","#1", DataTable("e_MontoDisputa",dtlocalSheet)
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").ClickCell "#2","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").SetCellData "#2","#1","12/09/2020"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").ClickCell "#3","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").SetCellData "#3","#1",DataTable("e_Suscripcion",dtlocalSheet)
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").ClickCell "#4","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").SetCellData "#4","#1","Reclamo"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").ClickCell "#10","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").SetCellData "#10","#1",DataTable("e_FacturaLegal",dtlocalSheet)
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").ClickCell "#11","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").SetCellData "#11","#1","12/02/2020" @@ hightlight id_;_87502_;_script infofile_;_ZIP::ssf10.xml_;_
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").ClickCell "#27","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").SetCellData "#27","#1","09-Otros" @@ hightlight id_;_87502_;_script infofile_;_ZIP::ssf11.xml_;_
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").ClickCell "#30","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").SetCellData "#30","#1","09-Otros" @@ hightlight id_;_87502_;_script infofile_;_ZIP::ssf12.xml_;_
	Set shell = CreateObject("Wscript.Shell") 
	shell.SendKeys "{DOWN}"
	
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").DoubleClickCell "#32","#1"
	wait 1
	'JavaWindow("Ejecutivo de interacción").InsightObject("InsightObject").Click
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").SetCellData "#32","#1","15-Lima"

'Set shell = CreateObject("Wscript.Shell") 
'	shell.SendKeys "{DOWN}"
	'JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").DoubleClickCell "#","#1"
	wait 1
		
'JavaWindow("Ejecutivo de interacción").InsightObject("InsightObject_2").Click
	
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").DoubleClickCell "#36","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Acuerdo de Facturación_4").JavaTable("SearchJTable").SetCellData "#36","#1","Sí"
...
Sub GeneracionDisputaCF
	...
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").DoubleClickCell "#0","#1"
	wait 1
	'JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").SetCellData "#0","#1", VencimientoFact
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").DoubleClickCell "#1","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").SetCellData "#1","#1","1.DNI"
	
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").DoubleClickCell "#2","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").SetCellData "#2","#1","19-Pasco"
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").DoubleClickCell "#3","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").SetCellData "#3","#1","04-Traslado"
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").DoubleClickCell "#4","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").SetCellData "#4","#1","04-Larga distancia nacional"
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").DoubleClickCell "#5","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").SetCellData "#5","#1","947908500"
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").DoubleClickCell "#6","#1"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").SetCellData "#6","#1","Otros" @@ hightlight id_;_87502_;_script infofile_;_ZIP::ssf10.xml_;_
	...
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").SetCellData "#7","#1","Sí" @@ hightlight id_;_87502_;_script infofile_;_ZIP::ssf11.xml_;_
	...
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Ver Cuenta Financiera:_5").JavaTable("SearchJTable").SetCellData "#8","#1",e_Monto @@ hightlight id_;_87502_;_script infofile_;_ZIP::ssf12.xml_;_
	Set shell = CreateObject("Wscript.Shell") 
	shell.SendKeys "{DOWN}"
